...
def detect_wuw():
    ...
    # porcupine_demo_mic --audio_device_index 2 --sensitivities 0.2 --keywords bumblebee
    pass


if __name__ == '__main__':
    detect_intent_stream(
        project_id=DIALOGFLOW_PROJECT,
        session_id=123456789,
        audio_file_path='call.wav',
        language_code=DIALOGFLOW_LANGUAGE
    )
